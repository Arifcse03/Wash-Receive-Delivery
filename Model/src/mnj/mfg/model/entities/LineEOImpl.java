...
public class LineEOImpl extends EntityImpl {
    ...
    public static final int ISSUEINSEEMSIZEDEO = AttributesEnum.IssueInseemSizeDEO.index();
    ...
    protected void create(AttributeList attributeList) {
        ...
        oracle.jbo.server.SequenceImpl s =new oracle.jbo.server.SequenceImpl("MNJ_MFG_ISSUE_REC_WASH_L_S",getDBTransaction());
